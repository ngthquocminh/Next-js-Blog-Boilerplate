...
const Home = (props: IhomeProps) => (
  ...
  >
    <Content>
      ...
      {/* Advantages */}
      <div className="relative mx-auto max-w-screen-lg mx-auto px-4 sm:px-6">
      ...
      {/* Help */}
      <div className="mx-auto max-w-screen-lg py-12 md:py-20 relative">
      ...
      {/* Booking */}
      <div id="booking" className="md:pt-20 my-8">
        <div className="pb-12 md:pb-20">
          <div className="relative bg-gray-900 py-10 px-8 md:py-28 md:px-12 shadow-2xl overflow-hidden aos-init aos-animate">
            <div className="mx-auto max-w-screen-lg relative flex flex-col lg:flex-row justify-between items-center gap-4">
              ...
              <form className="w-full lg:w-2/5">
                <div className="flex flex-col justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0 gap-3">
                  ...
                  <input
                    type="submit"
                    className="btn text-base w-40 text-white bg-blue-600 hover:bg-blue-700 shadow py-2 rounded-full"
                  />
                </div>
              </form>
            </div>
      ...
      {/* Services */}
      <div className="relative mx-auto max-w-screen-lg py-12 md:py-20 max-w-6xl">
        <div
      ...
      {/* Blogs */}
      <div className="relative mx-auto max-w-screen-lg py-12 md:py-20 max-w-6xl">
        <h4 className="text-2xl font-bold leading-snug tracking-tight mb-1 text-center">
          Nội dung nổi bật
        </h4>
